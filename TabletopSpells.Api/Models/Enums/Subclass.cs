...
{
    // Barbarian
    BarbarianPathOfTheBerserker, BarbarianPathOfTheTotemWarrior, BarbarianPathOfTheWildMagic,
    BarbarianPathOfTheZealot, BarbarianPathOfTheAncestralGuardian, BarbarianPathOfTheRune,
    BarbarianPathOfTheBeast, BarbarianPathOfTheWildHunt,
    // Bard
    BardCollegeOfLore, BardCollegeOfPerformance, BardCollegeOfGlamour, BardCollegeOfWhispers,
    BardCollegeOfSwords, BardCollegeOfEloquence, BardCollegeOfSpirits, BardCollegeOfPuppets,
    // Cleric
    ClericAirDomain, ClericAnimalDomain, ClericArcanaDomain, ClericDeathDomain, ClericForgeDomain,
    ClericGraveDomain, ClericKnowledgeDomain, ClericLifeDomain, ClericLightDomain, ClericNatureDomain,
    ClericTempestDomain, ClericTrickeryDomain, ClericWarDomain, ClericTwilightDomain,
    ClericLoveDomain, ClericOrderDomain,
    // Druid
    DruidCircleOfTheLand, DruidCircleOfTheMoon, DruidCircleOfSpores, DruidCircleOfDreams,
