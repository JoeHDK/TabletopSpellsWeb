...
const BATTLE_MASTER_MANEUVERS: FeatureChoiceOption[] = [
  ...
  { id: 'Brace', name: 'Brace', description: 'When a creature enters your reach, use your reaction to make one attack and add the superiority die to the attack’s damage on a hit.' },
  { id: "Commander's Strike", name: "Commander's Strike", description: 'Give up one attack and use a bonus action to direct an ally to strike; the ally uses its reaction, adds the superiority die to the attack’s damage, and can make one weapon attack.' },
  { id: 'Disarming Attack', name: 'Disarming Attack', description: 'Add the superiority die to the attack’s damage; the target makes a Strength save or drops one held item.' },
  { id: 'Distracting Strike', name: 'Distracting Strike', description: 'Add the superiority die to the attack’s damage; the next attack roll against the target by someone other than you has advantage.' },
  { id: 'Evasive Footwork', name: 'Evasive Footwork', description: 'Add a superiority die to AC while moving.' },
  { id: 'Feinting Attack', name: 'Feinting Attack', description: 'Use a bonus action to gain advantage on your next attack this turn; if it hits, add the superiority die to the attack’s damage.' },
  { id: 'Goading Attack', name: 'Goading Attack', description: 'Add the superiority die to the attack’s damage; the target makes a Wisdom save or has disadvantage on attacks against creatures other than you until the end of your next turn.' },
  { id: 'Lunging Attack', name: 'Lunging Attack', description: 'Increase your melee reach by 5 feet for one attack.' },
  { id: 'Maneuvering Attack', name: 'Maneuvering Attack', description: 'Add the superiority die to the attack’s damage; choose a friendly creature that can see or hear you to move up to half its speed without provoking opportunity attacks from the target.' },
  { id: 'Menacing Attack', name: 'Menacing Attack', description: 'Add the superiority die to the attack’s damage; the target makes a Wisdom save or is frightened of you until the end of your next turn.' },
  { id: 'Parry', name: 'Parry', description: 'Use your reaction when damaged by a melee attack to reduce the damage by the superiority die + your Dexterity modifier.' },
  { id: 'Precision Attack', name: 'Precision Attack', description: 'Add a superiority die to an attack roll after seeing it.' },
  { id: 'Pushing Attack', name: 'Pushing Attack', description: 'Add the superiority die to the attack’s damage; Large or smaller target makes a Strength save or is pushed up to 15 feet away.' },
  { id: 'Rally', name: 'Rally', description: 'Use a bonus action to give an ally temporary hit points equal to the superiority die + your Charisma modifier.' },
  { id: 'Riposte', name: 'Riposte', description: 'When a creature misses you with a melee attack, use your reaction to make a melee weapon attack and add the superiority die to the attack’s damage on a hit.' },
  { id: 'Sweeping Attack', name: 'Sweeping Attack', description: 'If you hit a creature with a melee attack, use the superiority die to damage a second creature within 5 feet of the original target and within your reach for the number rolled.' },
  { id: 'Trip Attack', name: 'Trip Attack', description: 'Add the superiority die to the attack’s damage; Large or smaller target makes a Strength save or is knocked prone.' },
]
...
const ALL_FEATURE_CHOICE_DEFINITIONS: FeatureChoiceDefinition[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'Banishing Arrow', name: 'Banishing Arrow', description: '+2d6 force damage on hit; Large or smaller target makes a Charisma save or is banished until the end of its next turn. Damage becomes 4d6 at level 18.' },
      { id: 'Beguiling Arrow', name: 'Beguiling Arrow', description: '+2d6 psychic damage on hit; target makes a Wisdom save or is charmed by an ally you choose until the start of your next turn. Damage becomes 4d6 at level 18.' },
      { id: 'Bursting Arrow', name: 'Bursting Arrow', description: 'The target and each creature within 10 feet take 2d6 force damage. Damage becomes 4d6 at level 18.' },
      { id: 'Enfeebling Arrow', name: 'Enfeebling Arrow', description: '+2d6 necrotic damage on hit; target makes a Constitution save or its weapon attacks deal half damage until the start of your next turn. Damage becomes 4d6 at level 18.' },
      { id: 'Grasping Arrow', name: 'Grasping Arrow', description: '+2d6 poison damage on hit; brambles reduce speed by 10 feet and deal 2d6 slashing damage the first time the target moves each turn until removed. Damage becomes 4d6 at level 18.' },
      { id: 'Piercing Arrow', name: 'Piercing Arrow', description: 'Fire in a 30-foot line; creatures in the line make a Dexterity save or take the arrow damage plus extra piercing damage, half on a success.' },
      { id: 'Seeking Arrow', name: 'Seeking Arrow', description: 'Curves toward a creature you have seen; it makes a Dexterity save or takes force damage, half on a success, and you learn its location. Damage becomes 4d6 at level 18.' },
      { id: 'Shadow Arrow', name: 'Shadow Arrow', description: '+2d6 psychic damage on hit; target makes a Wisdom save or can only see up to 5 feet away until the start of your next turn. Damage becomes 4d6 at level 18.' },
    ],
  },
  {
